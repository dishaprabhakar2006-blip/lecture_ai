...
> **Note:** The frontend is deployed on Vercel. The backend runs locally because the ML pipeline uses Whisper, FAISS, and SentenceTransformer, which require significant memory.
